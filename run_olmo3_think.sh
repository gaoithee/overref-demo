#!/bin/bash
#SBATCH --no-requeue
#SBATCH --job-name="olmo3-think-refusal"
...
#SBATCH --mem=100G
#SBATCH --output=slurm_outputs/olmo3_think_refusal_eval.out
...
mkdir -p slurm_outputs results/olmo3_think

python /u/scandussio/overref-demo/run_experiment.py \
    --config config_olmo3_think \
